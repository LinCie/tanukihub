...
export const metadata: Metadata = {
  title: "TanukiHub | Intro to Hiragana",
};
...
export default function Home() {
  return (
    <div id="home">
      ...
      <Paragraph>
        One Of the syllabaries used by the Japanese, mainly for Japanese words
        and grammatical elements,{" "}
      </Paragraph>
      {/* Sections */}
      {/* Navigations */}
      <BottomNavigation>
        <BottomNavigationLink href="/introductory/intro-to-japanese/">
